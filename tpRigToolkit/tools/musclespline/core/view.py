...
class MuscleSplineView(base.BaseWidget, object):
    ...
    def ui(self):
        ...
        self._main_muscle_set_line = lineedit.BaseLineEdit(parent=self)
        ...
        advanced_setup_set_layout.addWidget(self._main_muscle_set_line, 0, 1)
        advanced_setup_set_layout.addWidget(set_suffix_lbl, 1, 0, Qt.AlignRight)
        advanced_setup_set_layout.addWidget(self._muscle_set_suffix_line, 1, 1)
    ...
    def setup_signals(self):
        ...
        self._model.mainMuscleSetNameChanged.connect(self._main_muscle_set_line.setText)
    ...
    def refresh(self):
        ...
        self._main_muscle_set_line.setText(self._model.main_muscle_set_name)
