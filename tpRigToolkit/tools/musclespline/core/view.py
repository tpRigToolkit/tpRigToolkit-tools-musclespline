...
class MuscleSplineView(base.BaseWidget, object):
    ...
    def ui(self):
        ...
        muscle_setup_layout = layouts.GridLayout(spacing=5, margins=(2, 2, 2, 2))
        ...
        muscle_setup_layout.addWidget(name_label, 0, 0, Qt.AlignRight)
        muscle_setup_layout.addWidget(self._name_line, 0, 1)
        muscle_setup_layout.addWidget(size_label, 1, 0, Qt.AlignRight)
        muscle_setup_layout.addWidget(self._size_spn, 1, 1)
        muscle_setup_layout.addWidget(dividers.Divider(), 2, 0, 1, 2)
        muscle_setup_layout.addWidget(insertion_ctrls_lbl, 3, 0, Qt.AlignRight)
        muscle_setup_layout.addWidget(self._insertion_ctrls_spn, 3, 1)
        muscle_setup_layout.addWidget(insertion_type_lbl, 4, 0, Qt.AlignRight)
        muscle_setup_layout.addWidget(self._insertion_type_cbx, 4, 1)
        muscle_setup_layout.addWidget(dividers.Divider(), 5, 0, 1, 2)
        muscle_setup_layout.addWidget(num_driven_lbl, 6, 0, Qt.AlignRight)
        muscle_setup_layout.addWidget(self._num_driven_spn, 6, 1)
        muscle_setup_layout.addWidget(num_driven_type_lbl, 7, 0, Qt.AlignRight)
        muscle_setup_layout.addWidget(self._num_driven_type_cbx, 7, 1)
        muscle_setup_layout.addWidget(dividers.Divider(), 8, 0, 1, 2)
        muscle_setup_layout.addLayout(extras_layout, 9, 1)
